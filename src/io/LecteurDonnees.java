...
public class LecteurDonnees {
    ...
    public static DonneesSimulation donnees;
    ...
    private void lireCarte() throws DataFormatException {
        ...
        try {
            ...
            donnees.setMap(tailleCases, nbLignes, nbColonnes);
    ...
    private void lireCase(int lig, int col) throws DataFormatException {
        ...
        try {
            ...
            Map map = donnees.getMap();
            switch (chaineNature) {
                case "EAU" :
                    map.setCase(lig, col, LandNature.WATER);
                    break;
                case "FORET" :
                    map.setCase(lig, col, LandNature.FOREST);
                    break;
                case "ROCHE" :
                    map.setCase(lig, col, LandNature.ROCK);
                    break;
                case "TERRAIN_LIBRE" :
                    map.setCase(lig, col, LandNature.FREE_LAND);
                    break;
                case "HABITAT" :
                    map.setCase(lig, col, LandNature.HABITAT);
                    break;
            }
    ...
    private void lireIncendies() throws DataFormatException {
        ...
        try {
            ...
            donnees.setOnFireCases(nbIncendies);
    ...
    private void lireIncendie(int i) throws DataFormatException {
        ...
        try {
            ...
            Case position = donnees.getMap().getCase(lig, col);
            position.setIsOnFire(true);
            donnees.getOnFireCases().add(new Fire(position, intensite));
        } catch (NoSuchElementException e) {
    ...
    private void lireRobot(int i) throws DataFormatException {
        ...
        try {
            ...
            if (s == null) {
                ...
                switch (type) {
                    case "DRONE" :
                        donnees.getRobots()[i] = new Drone(position); 
                        break;
                    case "ROUES" :
                        donnees.getRobots()[i] = new WheelRobot(position);
                        break;
                    case "PATTES" :
                        donnees.getRobots()[i] = new FootRobot(position);
                        break;
                    case "CHENILLES" :
                        donnees.getRobots()[i] = new TankRobot(position);
                        break;
                ...
                switch (type) {
                    case "DRONE" :
                        donnees.getRobots()[i] = new Drone(position, vitesse);
                        break;
                    case "ROUES" :
                        donnees.getRobots()[i] = new WheelRobot(position, vitesse);
                        break;
                    case "PATTES" :
                        donnees.getRobots()[i] = new FootRobot(position, vitesse);
                        break;
                    case "CHENILLES" :
                        donnees.getRobots()[i] = new TankRobot(position, vitesse);
                        break;
                }
            }
            verifieLigneTerminee();
